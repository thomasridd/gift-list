...
export const useUpdateGift = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: ({ giftId, listId: _listId, request }: { giftId: string; listId: string; request: UpdateGiftRequest }) =>
...
export const useDeleteGift = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: ({ giftId, listId: _listId }: { giftId: string; listId: string }) =>
...
export const useReorderGift = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: ({ giftId, listId: _listId, request }: { giftId: string; listId: string; request: ReorderGiftRequest }) =>
...
export const useClaimGift = () => {
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: ({ giftId, shareCode: _shareCode, request }: { giftId: string; shareCode: string; request: ClaimGiftRequest }) =>
